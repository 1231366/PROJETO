    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form enctype="multipart/form-data" method="POST" novalidate="" action="DefUserEnf.php" id="form-dados">
<div class="container">
...
?>
              ...
              <div class="tab-content pt-3">
                <div class="tab-pane active">
                  <form class="form" action="DefUserEnf.php" novalidate="">
                    <div class="row">
                      <div class="col">
                        <div class="row">
                          <div class="col">
...
// Fechar a conexão com o banco de dados
mysqli_close($con);
echo '<script>window.location.href = "DefUserEnf.php?success=1";</script>';
}
?>
                </div>
              </div>
