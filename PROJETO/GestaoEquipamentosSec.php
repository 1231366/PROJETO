...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        if (window.location.search.includes('success=3')) {
            Toastify({
                text: 'Material eliminado com sucesso',
                duration: 3000,
                destination: 'AP_inicial.php',
                newWindow: true,
                close: true,
                ...
                stopOnFocus: true,
                callback: function() {
                    var newUrl = window.location.href.replace('?success=3', '');
                    history.replaceState(null, null, newUrl);
                }
            }).showToast();
        }
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Equipamentos em Stock <a href="+EquipamentoSec.php"><img src="img/AddUser.png" height="30px" align="right"></a></h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="equipamentosTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>Equipamento</th>
                        <th>Quantidade</th>
                ...
                <tbody>
                    <?php
                    include 'ligacao.php';
                    $query = "SELECT equipamentos.id_equipamentos, equipamentos.equipamento, SUM(inventario.quantidade) AS quantidade
          FROM equipamentos
          LEFT JOIN inventario
          ON equipamentos.id_equipamentos = inventario.id_equipamento
          GROUP BY equipamentos.id_equipamentos, equipamentos.equipamento";
                    ...
                    while ($linha = mysqli_fetch_array($resultado)) {
                        ...
                        echo "<td class='py-1'>
                            <a href='DeleteEquipamentoSec.php?id=".$linha["id_equipamentos"]."'>
                                <img src='img/DeleteUser.png' height='35px' alt='image'/>
                            </a>&nbsp&nbsp 
                            <a href='EditEquipamentoSec.php?id=".$linha["id_equipamentos"]."'>
