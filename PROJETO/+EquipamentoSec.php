...
<script>
    ...
    if(isset($_POST["btn_enviar"])){
        ...
        $query = "INSERT INTO equipamentos (equipamento) VALUES ('$equipamento')";
        mysqli_query($con, $query) or die("Erro na inserção do equipamento!");

        $id_equipamento = mysqli_insert_id($con);

        $query = "INSERT INTO inventario (id_equipamento, quantidade) VALUES ($id_equipamento, $quantidade)";
...
<script>
    ...
    window.location.href = 'GestaoEquipamentosSec.php?success=2';
</script>
<?php
    ...
    <div class="formbold-form-wrapper">
        <form action="+EquipamentoSec.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="submit" name="btn_enviar" class="formbold-btn" value="Registar Equipamento">
        </form>
    </div>
</div>
<?php } ?>
