                ...
                <?php
                      ...
                      If(isset($_POST["btn_enviar"])){
                        ...
                        $sesscontacto=$_POST["contacto"];
                            $nome_temp=$_FILES["upload"]["tmp_name"];
                            $nome_ficheiro=$_FILES["upload"]["name"];
                            copy($nome_temp, "Img/faces/$nome_ficheiro");
                        $data= date("Y/m/d");
                      ...
                      if($registos==1){
                          $query="UPDATE utilizadores SET nome='$novo_nome', login='$novo_login', password='$nova_password', foto='$nova_foto' WHERE id_utilizador='$id_utilizador'";

                          mysqli_query($con,$query) or die ("Erro na edição!");

                          echo "Registo alterado";
                      }
                      else{
...
?>
echo "<form name='editar' action='edit_utilizadores.php?id=".$id_utilizador."' method='Post'>";
                      echo "Qual é o novo nome: <input type='text' name='nome' value='".$linha["nome"]."' requery><br>";
                      echo "Qual é o novo login: <input type='text' name='login' value='".$linha["login"]."' requery><br>";
                      echo "Qual é a nova password: <input type='text' name='password' value='".$linha["password"]."' requery><br>";
                      echo "Qual é a nova foto: <input type='file' name='foto' value='".$linha["foto"]."' requery><br>";
                      ?>
