...
if (isset($_POST['btn_enviar'])) {
    ...
    $novo_equipamento = $_POST['equipamento'];
    $nova_quantidade = $_POST['quant'];

    // Atualizar o nome do equipamento na tabela equipamentos
    $query_equipamento = "UPDATE equipamentos SET equipamento = '$novo_equipamento' WHERE id_equipamentos = $id_equipamento";
    $result_equipamento = mysqli_query($con, $query_equipamento);

    // Atualizar a quantidade na tabela inventario
    $query_inventario = "UPDATE inventario SET quantidade = $nova_quantidade WHERE id_equipamento = $id_equipamento";
    $result_inventario = mysqli_query($con, $query_inventario);

    if ($result_equipamento && $result_inventario) {
        ...
        <script>
            ...
            window.location.href = 'GestaoEquipamentos.php?sucess=1';
        </script>
    <?php
        exit();
    } else {
    ...
    // Recuperar os dados existentes do equipamento e quantidade
    $id_equipamento = $_GET['id'];
    $query = "SELECT * FROM equipamentos WHERE id_equipamentos = $id_equipamento";
    $result = mysqli_query($con, $query);
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $query_inventario = "SELECT quantidade FROM inventario WHERE id_equipamento = $id_equipamento";
        $result_inventario = mysqli_query($con, $query_inventario);
        $row_inventario = mysqli_fetch_assoc($result_inventario);
        $quantidade = $row_inventario['quantidade'];
    } else {
        // Registro do equipamento não encontrado
        echo "Registro do equipamento não encontrado.";
        exit();
    }
}
?>
...
<div class="formbold-form-wrapper">
    <form action="EditEquipamento.php" method="POST" enctype="multipart/form-data">

        <div class="formbold-input-flex">
            <div>
                <label for="equipamento" class="formbold-form-label" >Equipamento</label>
                <input
                    type="text"
                    name="equipamento"
                    id="equipamento"
                    ...
                    value="<?php echo $equipamento;?>"
                    readonly
                />
            </div>
            <div>
                <label for="quant" class="formbold-form-label">Quantidade</label>
                <input
                    type="number"
                    name="quant"
                    id="quant"
        ...
        <input type="hidden" name="id_equipamento" value="<?php echo $id_equipamento; ?>">
            <input type="submit" name="btn_enviar" class="formbold-btn" value="Editar Equipamento">
        </form>
