                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                           ...
                                           WHERE id_trabalhador = '$idTrabalhador' AND sitio = 1 AND DATE(data_hora_inicio) = CURDATE()";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                $queryConsultas = "SELECT COUNT(*) AS total_consultas FROM consultas
                                           WHERE id_trabalhador = '$idTrabalhador' AND sitio = 2 AND DATE(data_hora_inicio) = CURDATE()";
                                                $resultConsultas = mysqli_query($con, $queryConsultas);
                       ...
                       <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                           <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Consultas e Domicílios concluídos
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
...
$queryConsultasAgendadas = "SELECT COUNT(*) AS total_agendadas FROM consultas
                           WHERE id_trabalhador = '$idTrabalhador' 
                           AND DATE(data_hora_inicio) = '$dataAtual'";
...
<script>
    ...
    <input type="submit" id="saveBtn" class="btn btn-primary" name="submeter" value="Enviar">
</div>
                                                </form>
                                            </div>
                                        </div>
