...
<body id="page-top">
    ...
    if(isset($_POST["btn_enviar"])){
        $sessmaterial = $_POST["material"];
        $sessquantidade = $_POST["quant"];

        include "ligacao.php";

        $query = "INSERT INTO materiais (material) VALUES ('$sessmaterial')";
        mysqli_query($con, $query) or die("Erro na inserção do material!");

        $id_material = mysqli_insert_id($con);

        $query = "INSERT INTO inventario (id_material, quantidade) VALUES ($id_material, $sessquantidade)";
        mysqli_query($con, $query) or die("Erro na inserção da quantidade!");

        mysqli_close($con);

        echo "Gravado com sucesso!";
        echo "<br> <a href='GestaoStock.php'>Voltar</a>";
?>
<script>
    // Redirecionar imediatamente
    window.location.href = 'GestaoMateriais.php';
</script>
<?php
    } else {
    ?>
              ...
              <span class="formbold-opacity-0">
                ...
                >
                  ...
                  />
                        ...
                        <input type="submit" name="btn_enviar" class="formbold-btn" value="Registar Material">
                        </form>
                    </div>
                    </div>
                    </form>
