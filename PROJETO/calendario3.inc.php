...
if (isset($_POST['submeter'])) {
    ...
    // Replace "workerId" with the variable that contains the worker ID
    $workerId = $_GET["idt"];
    
    // Redirect using JavaScript
    echo '<script>window.location.href = "agendatrabalhador.php?id=' . $workerId . '&sucess=1";</script>';
}
if (isset($_POST['enviar'])) {
    ...
    $tipoConsulta=$_POST['tipo_consulta'];
        ...
        // Redirect using JavaScript
        echo '<script>window.location.href = "agendatrabalhador.php?id=' . $workerId . '&sucess=2";</script>';
    }
    ...
    if(isset($_GET['id_consulta'])){
        ...
        // Redirect using JavaScript
        echo '<script>window.location.href = "agendatrabalhador.php?id=' . $workerId . '&sucess=3";</script>';
