                    ...
                    <h1 class="h3 mb-4 text-gray-800"><div class="formbold-main-wrapper">
                        ...
                        <form action="+consulta.php" method="POST">
                            <div class="formbold-mb-5">
                                <label for="searchInput" class="formbold-form-label">Digite o nome do paciente</label>
                                <input id="searchInput" type="text" class="form-control bg-light border-0 small" placeholder="Pesquisar paciente..."
                                aria-label="Search" aria-describedby="basic-addon2" onclick="showPacientes()" autocomplete="off">
                                <input type="hidden" name="selectedPatientId" id="selectedPatientId" value="<?php echo $id; ?>">
                            </div>
                            <script>
                            ...
                            $('.paciente').click(function() {
                                ...
                                $('#selectedPatientId').val(patientId); // Atualiza o valor do ID do paciente
                                var pacientes = document.getElementById("pacientes");
                                pacientes.style.display = "none";
                            });

                            function submitForm() {
                            var selectedPatientId = $('#selectedPatientId').val(); // Obtém o valor do ID do paciente
                            if (selectedPatientId === "") {
                                alert("Selecione um paciente.");
                                return false;
                            }
                            // Resto do código para submeter o formulário
                            }
                            </script>
                            ...
                            <div class="formbold-mb-5 formbold-pt-3">
                                ...
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                    <label class="formbold-form-label">Local</label>
                                    <select class="formbold-form-input" name="local" id="local">
                                ...
                                <div class="w-full sm:w-half formbold-px-3">
                                    <div class="formbold-mb-5">
                                    <label class="formbold-form-label">Tipo de Consulta</label>
                            <select class="formbold-form-input" name="tipo_consulta" id="tipo_consulta">
                            <option value="1">Saúde Infantil</option>
                            <option value="2">Saúde Grávida</option>
                            <option value="3">Vacinação</option>
                            <option value="4">Consulta de Diabetes</option>
                            ...
                            <div>
                                <label for="message" class="formbold-form-label">Observações</label>
                            ...
                            <div>
                                ...
                                <button class="formbold-btn" onclick="submitForm()">Agendar consulta</button>
                            </div>
                            </form>
                            <?php
                            require_once 'ligacao.php';
                            ...
                            $pacienteId = $_POST['selectedPatientId'];
                            $data = $_POST['date'];
                            $hora = $_POST['time'];
                            $local = $_POST['local'];
                            ...
                            // Aqui você pode definir a lógica para calcular a data e hora final da consulta

                            // Inserir os dados na tabela de consultas
                            $query = "INSERT INTO consultas (id_paciente, id_trabalhador, data_hora_inicio, data_hora_fim, id_tipo_consulta, observacoes)
                                        VALUES ('$pacienteId', '0', '$dataHoraInicio', '0000-00-00 00:00:00', '$tipoConsulta', '$observacoes')";
                            $result = mysqli_query($con, $query);
                            ...
                            $('.paciente').click(function() {
                            var patientId = $(this).data('id');
                            $('#patientIdInput').val(patientId); // Atribui o ID do paciente ao campo de input
                            });

                            function submitForm() {
                                var selectedPatientId = $('#paciente_id').val();
                                if (selectedPatientId === "") {
                                alert("Selecione um paciente.");
                                return false;
                                }
